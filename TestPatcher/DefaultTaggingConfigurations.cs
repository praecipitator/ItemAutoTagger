namespace ItemTagger
{
    ...
    internal class DefaultTaggingConfigurations
    {
        ...
        {
            // FIS
            defaultConfigs.Add(TaggingConfigType.FIS, new TaggingConfiguration(
                "[Scrap]",
                "[Scrap]",
                "[Resource]",
                "[Mod]",
            ...
            // LWIS
            defaultConfigs.Add(TaggingConfigType.LWIS, new TaggingConfiguration(
                "{Shipment}",
                "{Scrap}",
                "{Resource}",
                "{Mod}",
            ...
            // VIS
            defaultConfigs.Add(TaggingConfigType.VIS, new TaggingConfiguration(
                "{Scrap}",
                "{Scrap}",
                "{Resource}",
                "{Mod}",
            ...
            // VIS-G
            defaultConfigs.Add(TaggingConfigType.VISG, new TaggingConfiguration(
                "(Resource)",
                "{Scrap}",
                "(Resource)",
                "{Mod}",
